...
const tiny_dsl_module_1 = require("../language-server/tiny-dsl-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, tiny_dsl_module_1.createTinyDslServices)(node_1.NodeFileSystem).TinyDsl;
...
function default_1() {
    ...
    const fileExtensions = module_1.TinyDslLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
